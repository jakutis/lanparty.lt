...
//
// These tests cover manual-verification.md steps 1, 2, 4, 6, 8, 9 and the header/error
...
test("contract", { concurrency: false }, async (t) => {
  ...
  await t.test(
    "GET / references marked from a CDN (verifying step 9)",
    async () => {
  ...
  await t.test(
    "GET /marked.min.js is 404 (no local vendored marked)",
    async () => {
  ...
  await t.test(
    "GET /v1/representation is 405 (verifying step 4: method check)",
    async () => {
  ...
  await t.test(
    "POST /v1/representation with blank spec is 422 + api error shape (step 6)",
    async () => {
  ...
  await t.test(
    "POST /v1/representation with unsupported type is 422 (step 6)",
    async () => {
      const res = await fetch(base + "/v1/representation", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  await t.test(
    "POST /v1/representation html -> 200 with the right headers (step 8)",
    async () => {
      const res = await fetch(base + "/v1/representation", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
      ...
      assert.equal(
        ...
        'attachment; filename="representation.html"',
      );
      const body = await res.text();
  ...
  await t.test(
    "POST /v1/representation markdown -> 200 with the right headers (step 8)",
    async () => {
      const res = await fetch(base + "/v1/representation", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
      ...
      assert.equal(
        res.headers.get("content-disposition"),
        'attachment; filename="representation.md"',
      );
      const body = await res.text();
  ...
  await t.test(
    "the request body and Content-Type match the spec (step 8)",
    async () => {
